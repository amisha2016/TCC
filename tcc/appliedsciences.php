		...
		<!-- Intro -->
			<section id="intro" class="main style1 dark fullscreen">
				<div class="content container small">
					...
					<p class="primary-text"><strong>Mechanical and Production Department</strong> has the following labs:
					<ol class="work-list">					
					<li>1. Chemical Analysis of Cement</li>
					<li>2. Chemical Analysis of Cement Mortar</li>
					<li>3. Chemical Analysis of Cement Concrete</li>
					<li>4. Test of Water</li>
					<li>5. Chemical Analysis of Coarse/Fine Aggregates</li>
					<li>6. Chemical Analysis of Soil/Sand</li>
					<li>7. Chemical Analysis of Boiler water</li>
					<li>8. Flash Point of Fuels</li>
					<li>9. Penetration Number of Lubricant</li>
					</ol>
					</p>
					<footer>
		...
		<!-- Work -->
			<section id="work" class="main style3 primary">
				<div class="content container">
					<header>
						<h2>Glimpse of Applied Sciences</h2>
