		...
		<!-- Intro -->
			<section id="intro" class="main style1 dark fullscreen">
				<div class="content container small">
					...
					<p class="primary-text"><strong>Industrial & Software Training</strong> is provided to the students of both Computer and Civil Departments. The duration of training is 6 weeks  and 6 months for 2nd year and 4th year students respectively.<br> Following is the list the students who have been trained at TCC.
						<ul class="work-list">
							<li><a href= "JanJune6m1314.php">Batch Jan 2013</a></li>
							<li>6 months</li>
						</ul>
					</p>
		...
		<!-- Work -->
			<section id="work" class="main style3 primary">
				<div class="content container">
					<header>
						<h2>Glimpse of Civil Department</h2>
