		...
		<!-- Intro -->
			<section id="intro" class="main style1 dark fullscreen">
				<div class="content container small">
					...
					<p class="primary-text">We have been providing services for around 30 years, growing every year, setting new benchmarks. TCC has accomplished more than 20,000 jobs, More than 10 Crores of testing has been done till the date.
Our major clients and main project are:
					<ol>					
						<li>Executive Engineer, Provincial Division PWD(B&R) Br., Ludhiana worth</li>
						<li>S.P. Vigilance Bureau, Headquarter, Ludhiana worth</li>
						<li>Executive Engineer, Provincial Division, PWD(B&R), Ludhiana</li>
						<li>Executive Engineer, Provincial Division, PWD(B&R), Shaheed Bhagat Singh Nagar, Ludhiana</li>
						<li>Ludhiana Centre of ICI(I), Ludhiana</li>
						<li>Executive Engineer, W/S & Sani. Divn.No.2, Muktsar</li>
						<li>Sub Divisional Engineer, Pb. W/S & Sew. Sub Division No.1, Jalandhar
</li>
						<li>M/s.Singla Consultants, Patiala
</li>
						<li>Punjab Pollution Control Board, Plot-55, Phase-2, S.A.S. Nagar, Mohali</li>
						<li>M/S. MeriTrac Services Pvt. Ltd., D-22/23 Institutional Area, Pankha Road janakpuri, New Delhi</li>
					<ol>
					</p>
					<footer>
