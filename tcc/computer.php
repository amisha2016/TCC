		...
		<!-- Intro -->
			<section id="intro" class="main style1 dark fullscreen">
				<div class="content container small">
					<header >
						<h2 class="primary-branding">Computer Science & Information Technology</h2>
					</header>
					<p class="primary-text"><strong>Computer Science Engineering and Information Technology</strong> department provides various facilities like :
						<ol class = 'work-list' type="1">
							<li>1. Networking -installation and Maintenance</li>
							<li>2. Hardware fault Diagnosis & Testing</li>
							<li>3. Installation & Configuration of Servers</li>
							<li>4. Desktop Publishing(DTP)</li>
						</ol>
						<h3>Labs:</h3>
						<ol class = 'work-list' type="1">
							<li>1. Operating System Lab-1</li>
							<li>2. Operating System Lab-2</li>
							<li>3. Project Lab-1</li>
							<li>4. Project Lab-2</li>
							<li>5. Hardware Lab</li>
							<li>6. Software Lab-1</li>
							<li>7. Software Lab-2</li>
							<li>8. Web Development Lab</li>
							<li>9. DBMS Lab</li>
							<li>10. Computer Network Lab<li>
							<li>11. Research Lab</li>
						</ol>
					</p>
					<footer>
