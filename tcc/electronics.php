...
<html>
	<head>
		<title>Electronics Department</title>
		...
		<!-- Intro -->
			<section id="intro" class="main style1 dark fullscreen">
				<div class="content container small">
					...
					<p class="primary-text"><strong>Electronics Department</strong> has the following facilities:
						<ol class="work-list">					
							<li>1. Projects based on installation, interfacing, programming and testing on Micro controllers, Microprocessors and PLCs.</li>
							<li>2. Industrial Electronics based Application and trouble shooting.</li>
							<li>3. Fuzzy Logic based control systems.</li>
							<li>4. PCB Design and Development.</li>
							<li>5. Projects on Antenna(Simulation & Design).</li>
						</ol>

					<h1><b>Labs:</b></h1>
						<ol class="work-list">
							<li>1. Communication and T.V.</li>
							<li>2. Micro-wave</li>
							<li>3. Digital Electronics and Project</li>
							<li>4. Electronics Design and Automation Lab</li>
							<li>5. Microprocessor and Hardware</li>
							<li>6. Fiber optics & Multimedia</li>
						<ol>
					</p>
					<footer>
